...
class BookSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $book7 = Book::create([
            ...
            'publisher_id' => Publisher::where('name', 'أكاديمية حسوب')->first()->id,
            'title' => 'ريادة الأعمال',
            'description' => 'ريادة الأعمال هي عنصر أساسي لاستمرار دورة الحياة الاقتصادية، وخلق أسواق جديدة مفيدة للناس باستمرار، فهي تقدم حلولًا لمشاكل يحتاج الناس لحلٍ لها، كما تقدم بدائل جيدة بأفكار جديدة وتطرحها في السوق بطريقة إبداعية؛ وفي أحيان كثيرة هي تفتح أسواقًا جديدةً أساسًا، أو تستفيد من فرصة ما وتطرح فكرة جديدة، أو مطورة عبر إدخال إضافة لما كان موجودًا سابقًا، مما يسمح بالتواجد في السوق والريادة فيه.

            تُعَد ريادة الأعمال مجالًا كاملًا قد يتعلمه الطلاب في الجامعة إن كان تخصصهم ضمن مجال الأعمال والاقتصاد، لكنه قد يكون مهملًا أحيانًا لطلاب التخصصات الأخرى رغم أهميته الشديدة في تحقيق إضافة في السوق، أو إطلاق أو تطوير مشروع ما لأشخاص من تخصصات دراسية أخرى .',
            'number_of_copies' => '300',
            'number_of_pages' => '288',
            'price' => '25',
            'isbn'=>'100000000006',
        ...
        $book7->authors()->attach(Author::where('name', 'هشام دهرار')->first());

        $book8 = Book::create([
            'category_id' => Category::where('name', 'كتب برمجة')->first()->id,
            'publisher_id' => Publisher::where('name', 'أكاديمية حسوب')->first()->id,
            'title' => 'أتمتة المهام المملة عبر بايثون',
            'description' => 'تقع البرمجيات في صلب العديد من الأدوات التي نستعملها يوميًا، فتقريبًا كلنا يستعمل الشبكات الاجتماعية للتواصل، ولدينا هواتف ذكية في جيوبنا طوال الوقت، وأغلبية الأعمال المكتبية تتطلب تفاعلًا بشكلٍ أو بآخر مع الحواسيب، ونتيجةً لذلك زادت الحاجة إلى الأشخاص الذين يستطيعون البرمجة ازديادًا عظيمًا أخيرًا، وظهر عدد كبير من الكتب والمقالات والدورات التي تعد المبتدئين أن يصبحوا مهندسي برمجيات برواتب عالية.

            هذا الكتاب ليس لتلكم الفئة، بل لجميع الفئات الأخرى! إن كنت تعمل عملًا مكتبيًا أو كنت مديرًا للأنظمة أو كنت أكاديميًا أو كنت تحب أن تمرح مع حاسوبك فهذا الكتاب لك، وستتعلم فيه أساسيات البرمجة لكي تتمكن من أتمتة المهام التي تأخذ وقتًا طويلًا من وقتك في العادة، وتكون إما بسيطة أو مخصصة جدًا فلا يوجد برنامج متاح لإنجازها، لكن بعد تعلمك لأساسيات البرمجة فيمكنك أن تجعل حاسوبك يقوم بها بدلًا منك.',
            'number_of_copies' => '300',
            'number_of_pages' => '288',
            'price' => '30',
            'isbn'=>'100000000007',
        ...
        $book8->authors()->attach(Author::where('name', 'عبداللطيف إيمش')->first());
    }
}
