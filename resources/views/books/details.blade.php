    ...
    <script>
        document.querySelectorAll('.rating-star').forEach(function(star) {
            star.addEventListener('click', function() {
                ...
                var submitStars = star.getAttribute('data-value');
                ...
                fetch('{{$book->id}}' + '/rate', {
                    ...
                    body: JSON.stringify({value: submitStars})
                }).then(res => {
                    if(res.ok) {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.addCart').forEach(function (button) {
                button.addEventListener('click', function (event) {
                    ...
                    var bookId = form.querySelector('#bookId').value;
                    ...
                    fetch(url, {
                        ...
                        body: JSON.stringify({
                         ...
                         document.querySelector('span.badge').textContent = data.num_of_product;
                        var notyf = new Notyf();
                        notyf.success('تم إضافة الكتاب بنجاح');
                    }).catch(() => {
                        alert('حدث خطأ ما')
                    })
